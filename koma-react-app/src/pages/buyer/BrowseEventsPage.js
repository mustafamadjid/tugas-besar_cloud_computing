        ...
        <main className="events-content">
          <div className="content-header">
            {isAuthenticated && user && (
              <p className="welcome-message">Halo, {user.name || user.email}!</p>
            )}
            <h1>Jelajah & Cari Event</h1>
            <p>Lihat daftar event konser, filter berdasarkan tanggal, lokasi, genre, harga, dan cari berdasarkan artis, event, atau promotor.</p>
            <p>{filteredEvents.length} event ditemukan</p>
          </div>
